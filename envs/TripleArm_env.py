...
class TripleArmEnv:
    ...
    def __init__(self,
        ...
        self.continuous_joints = range(18)
    ...
    def _generate_free_configuration(self, n_tries=100):
        ...
        pos_lower_lim = np.array([-5, -1.0, 1.0, -0.2, -2.5, -0.0001] * 3)
        pos_upper_lim = np.array([-1.5, 0.5, 2.0, 0.8, -0.5, 0.0] * 3)
    ...
    def _different_arm_collision_check(self, fk_dict, distance=False):
        ...
        if not distance:
            ...
            collision = collision12 or collision13
            ...
            return min(distance12, distance13), name_pairs
...
if __name__ == '__main__':
    ...
    robot = robots2.ZonoArmRobot.load(os.path.join(os.getcwd(),'envs/arm_urdfs/ur5/triple_ur5.urdf'), create_joint_occupancy=False)
    ...
    for i in range(100):
        qpos = env.qpos
        velocity_action = np.random.random(18) - 0.5
