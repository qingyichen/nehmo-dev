...
class DualArmEnv:
    ...
    def __init__(self,
        ...
        self.continuous_joints = range(12)
...
if __name__ == '__main__':
    ...
    robot = robots2.ZonoArmRobot.load(os.path.join(os.getcwd(),'envs/arm_urdfs/ur5_franka/ur5_franka.urdf'), create_joint_occupancy=False)
