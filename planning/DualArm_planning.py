...
from envs.DualArm_env import DualArmEnv, FullStepRecorder, RobotStepViz
...
def load_robot(opt):
    ...
    robot = robots2.ZonoArmRobot.load(os.path.join(os.getcwd(), f'envs/arm_urdfs/{robot_name}/dual_{robot_name}.urdf'), create_joint_occupancy=False)
    return robot
